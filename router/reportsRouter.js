...
router.get("/dailyReports/download", userAuthentication, reportsController.downloadDailyReport);
router.get("/monthlyReports/download", userAuthentication, reportsController.downloadMonthlyReport);
